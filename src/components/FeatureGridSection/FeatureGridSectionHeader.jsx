    ...
    <header className="flex flex-col w-full gap-[40px] md:flex-row  ">
      ...
      <div className='md:w-[600px] gap-[12px] flex flex-col' >
        <span className={`font-sans text-[12px]
            ...
            ${theme === "dark" ? "text-[#75A2F0] bg-[#081D5B]" : "text-primary-blue bg-[#EBF2FD] "} pt-[4px] pb-[4px] pr-[12px] pl-[12px] self-start rounded-[999px]`}><img className='inline' src={icons[0]}/> {badge}</span>
        <p
