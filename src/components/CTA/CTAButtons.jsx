    ...
    <div className={`cta-buttons bg-transparent flex flex-col items-center gap-3 w-full`}>
      <div className="flex flex-col md:flex-row justify-center gap-3 w-full max-w-sm md:max-w-none">
        <button onClick={() => navigate('/signup')}
          className="bg-primary-blue text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition-colors duration-300 w-full md:w-auto">
          {buttons.primary}
        </button>

        <button onClick={() => navigate('/ContactUs')}
          className="border-1 border-white text-semi-white px-6 py-3 rounded-lg font-medium hover:bg-white/5 transition-colors duration-300 w-full md:w-auto flex items-center justify-center gap-2">
          {buttons.secondary}
