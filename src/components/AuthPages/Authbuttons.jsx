...
export function PrimaryButton({ children, onClick, type = "submit" }) {
  return (
    <button
      type={type}
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2 py-3 rounded-lg font-semibold text-sm text-white bg-blue-600 hover:bg-blue-700 transition-colors"
    >
      {children}
      <ArrowRight size={16} />
    </button>
